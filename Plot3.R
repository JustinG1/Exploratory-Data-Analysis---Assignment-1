...
## Step 4: Plot the 3 lines
plot(hpcsub$Datetime, hpcsub$Sub_metering_1, ylab = "Energy sub metering", type = "l")
points(hpcsub$Datetime,hpcsub$Sub_metering_2, col = "red",  type = "l")
points(hpcsub$Datetime, hpcsub$Sub_metering_3, col = "blue", type = "l")

## Step 5: Add the legend in the top right corner
legend("topright", pch = "______", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), col = c("black", "red", "blue"))
